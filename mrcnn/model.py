...
Arash: I editted detection layer to be able to limit number of detected instances of a class and also number of overall detections in an image separately.
"""
