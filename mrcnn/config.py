...
class Config(object):
    ...
    DETECTION_MAX_INSTANCES_ALL_CLASSES = 35 #Arash
    ...
    DETECTION_NMS_THRESHOLD_ALL_CLASSES = 0.3
    ...
    # implementation.
    LEARNING_RATE = 0.001
    LEARNING_RATE_LIST = [0.01, 0.001, 0.0001, 0.00001] #Arash
    LEARNING_RATE_EPOCH_STEPS = [10, 20, 30]   #Arash
    ...
    def __init__(self):
        ...
        #print('set image meta size: ', self.IMAGE_META_SIZE)#Arash
